...
# This is from Django revision 5769, with the "ticket-4899.2.diff" patch from
# Django ticket 4899.
# It has been modified to parse ".txt" files in addition to its normal behavior
# of parsing ".py" and ".html" files.
