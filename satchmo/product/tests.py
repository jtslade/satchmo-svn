...
>>> white_shirt = Product.objects.create(slug="django-shirt_small_white", full_name="Django Shirt (White/Small)")
...
>>> clash_shirt = Product.objects.create(slug="django-shirt_small_black", full_name="Django Shirt (Black/Small)")
