...
class Discount(models.Model):
    ...
    amount = models.DecimalField(_("Discount Amount"), decimal_places=2, max_digits=4, blank=True, null=True,
                                help_text=_("Enter absolute amount OR percentage"), validator_list=[amount_validator])
    percentage = models.DecimalField(_("Discount Percentage"), decimal_places=2, max_digits=4, blank=True, 
    ...
    minOrder = models.DecimalField(_("Minimum order value"), decimal_places=2, max_digits=6, blank=True, null=True)
