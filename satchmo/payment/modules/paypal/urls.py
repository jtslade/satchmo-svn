...
urlpatterns = patterns('satchmo',
     (r'^$', 'payment.modules.paypal.views.pay_ship.pay_ship_info', {'SSL': SSL}, 'PAYPAL_satchmo_checkout-step2'),
     (r'^confirm/$', 'payment.modules.paypal.views.confirm.confirm_info', {'SSL': SSL}, 'PAYPAL_satchmo_checkout-step3'),
